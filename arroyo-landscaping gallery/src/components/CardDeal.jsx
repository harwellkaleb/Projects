...
const ContactForm = () => {
  ...
  return (
    <section id="contact">
      ...
      >
        <h2 className={`${styles.heading2} mt-10 mb-10 `}>Contact Form</h2>
        <form className={`${styles.flex} md:flex-col justify-center items-center`}ref={form} >
          ...
          <button
            type="submit"
            className={`py-4 px-6 font-poppins font-medium text-[18px] text-primary mt-20 bg-blue-gradient rounded-[10px] outline-none ${styles.flexCenter}`}
