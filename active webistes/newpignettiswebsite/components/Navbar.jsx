...
const Navbar = () => {
  ...
  // }, []);
    ...
    <nav
      className="w-full flex border-b-2 border-black justify-between items-center bg-[#804040] p-4"
    >
      ...
      <div className="flex">
        ...
        {toggleMenu && (
        <div className="fixed top-0 left-0 w-full h-screen bg-[#804040] transition-all duration-500 ease-in-out flex-col z-50
