        ...
        {toggleMenu && (
          <div className="app__navbar-smallscreen_overlay flex__center slide-bottom">
            ...
            <ul className='app__navbar-smallscreen_links'>
              ...
              <li className='p__opensans'><a href='https://www.opentable.com/pignettis-italian-restaurant-reservations-temple?restref=168931&lang=en-US&ot_source=Restaurant%20website' target='_blank' rel="noreferrer" onClick={() => setToggleMenu(false)}>Book a table</a></li>
