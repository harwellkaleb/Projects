...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className={`flex md:flex-row z-10   flex-col `}
    >
      {showScroll && (
        <button
          onClick={scrollTop}
      ...
      >
        <div className="flex flex-row items-center mb-6  py-[8px] px-5 bg-discount-gradient rounded-[10px] ">
          <a className="flex" href="#contact">
            <img src={sprayBottle} alt="discount" className="w-[32px] h-[32px] " />
        ...
        <div className="flex flex-col justify-center  items-center w-full">
          <h1 className="flex-1 text-center font-poppins pt-2 font-semibold xs:text-[49px] sm:text-[92px] md:text-[142px] text-[152px] text-white xs:leading-[50.8px] sm:leading-[100.8px] ss:leading-[60.8px] md:leading-[130.8px] leading-[75px]">
            E<span className='text-[80%]'>&#38;</span>D  <br className="sm:block hidden" />{" "}
        ...
        <h2
          className={`${styles.heading2} w-full flex justify-center items-center xs:text-center xs:text-[55px] sm:text-[60px]   md:text-[60px] leading-[75px] pb-6  text-center max-w-[470px]`}
        >
          <span className='flex flex-col md:flex-row'> Commercial <span className='text-[80%] mx-2'>&#38;</span> Residential</span> 
        </h2>
      </div>
